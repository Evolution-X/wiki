...
| **Act 3:**   Maintainers must do the command down below in/against their build environment whenever building **OFFICIAL** so the build will ship OTA Updater, GApps and will be releasable.
...
| **Act 5:**   Maintainers can add additional bots in their group as long as it does not conflict with any clauses and acts of this CoC and is deemed appropriate.
