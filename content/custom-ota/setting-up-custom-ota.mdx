...
Inside your device tree, locate the overlay-evolution folders you created and inside of them create Updater directory with its subfolders (assuming you commited the EvolutionX init changes)
