...
Once you have completed the Ubuntu setup steps above, please proceed to [Step 3 of the Environment Setup](setting-up-env#h-3-make-a-folder-and-initialize-repo) for further instructions.