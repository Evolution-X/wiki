...
<Callout type="info">
  This guide has been tested to work on Ubuntu 20.04.6 LTS
</Callout>
...
If you want to use latest Ubuntu LTS to build EvolutionX please review [Setting up Ubuntu 24.04 to build Evolution X](./setting-up-ubuntu-latest-lts.mdx)
...
{<summary className="p-2 x:focus-visible:nextra-focus x:cursor-pointer x:transition-colors x:hover:bg-gray-100 x:dark:hover:bg-neutral-800 x:select-none x:rounded x:[&::-webkit-details-marker]:hidden x:flex x:items-center">
  <svg viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="3" height="1em" class="x:motion-reduce:transition-none x:ms-2 x:me-1 x:shrink-0 x:rtl:rotate-180 x:[[data-expanded]>summary:first-child>&amp;]:rotate-90 x:transition"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round"></path></svg>
...
<Callout type="info">
  Before running compilation process you can [Set up custom OTA updates] (./setting-up-ubuntu-latest-lts.mdx).
</Callout>
